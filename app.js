...
Write a function called sumAndMultiply() that takes in three numbers as separate arguments
 and returns an array where the first element is the sum of those three numbers, the second element is the product of those three numbers,
...
and to do multiplication, use your multiply() function that you've already created. You're going to have to be resourceful to figure out how to
...
function sumAndMultiply(a, b, c) {
  //eslint-disable-line
    ...
    let multiplyB = multiply(multiplyA[0], c);

    return [sumB[0], multiplyB[0], a + ' and ' + b + ' and ' + c + ' sum to ' + sumB[0] + '.',
      'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + multiplyB[0] + '.']
}
...
element is the sum of the numbers in the array, and the second element is a string that EXACTLY follows this example and uses the values that
...
function sumArray(sumArr) {
  let tArray = testArray[0]+testArray[1]+testArray[2];
  
  return [tArray , testArray +   ' was passed in as an array of numbers, and ' + tArray + ' is their sum.' ]
...
the product of those numbers, and the second element is a string that EXACTLY follows this example and uses the values that were input 
into the function:
